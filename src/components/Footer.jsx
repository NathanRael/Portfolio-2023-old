...
export default function Footer() {
  ...
  return (
    <section className={`container-fluid m-0 p-0 mb-24 d-flex justify-content-between align-items-center mt-184 ${darkMode ? 'text-light bg-secondary' : 'text-dark bg-light'}`}>
