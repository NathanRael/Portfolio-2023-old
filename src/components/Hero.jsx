          ...
          <div className="row ">
            <div className="col-7 d-flex flex-column row-gap-40">
              <div className="container-fluid text-light row-gap-16">
                ...
                <h1 className="_title text-light">
                  ...
                  <span className="text-primary"> Develop</span> a visual
                  appealing website
                </h1>
              </div>
            ...
            <div className="col-5 d-flex gap-48">
              <div className="container d-flex">
                <img src={FigmaIcon} className="img-fluid align-self-start" alt=""/>
              </div>
              <div className="container d-flex">
                <img src={BootstrapIcon} className="img-fluid align-self-end" alt=""/>
              </div>
              <div className="container d-flex">
                <img src={ReactIcon} className="img-fluid align-self-start" alt=""/>
              </div>
            </div>
          </div>
        </section>
